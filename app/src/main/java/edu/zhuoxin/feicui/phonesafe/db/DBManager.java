...
public class DBManager {
    ...
    public static  void copyDbFileToStorage(Context context,File toFile){
        InputStream is = null;
        OutputStream os = null;
        try {
            is = context.getAssets().open("commonnum.db");
    ...
    public static List<ClassListInfo> readClassListInfo(Context context){
        ...
        if (file.exists()){
            ...
            copyDbFileToStorage(context,new File(context.getFilesDir(),"commonnum.db"));
        }
        // 递归
